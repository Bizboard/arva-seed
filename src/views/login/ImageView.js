...
export class ImageView extends View {
    ...
    @layout.stick.center()
    @layout.size(100, 44)
    pageTitle = new ImpactBig({ content: 'mrBox', properties: {color: Colors.PrimaryUIColor} });
    ...
    @layout.dockSpace(4)
    @layout.size(undefined, 300)
    image = new BkImageSurface({ content: MrBox, sizeMode: BkImageSurface.SizeMode.ASPECTFIT });
}
